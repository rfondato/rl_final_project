...
def parse_arguments():
    ...
    parser.add_argument("-t", "--timesteps", type=int,
                        help="Amount of timesteps to train the model. Default: 10e5", default=10e5)
...
Opponent's class: {args.opponent}
...
Opponent's path: {args.opp_path if args.opp_path is not None else "None"}
...
def learn(args):
    ...
    model = CustomReversiModel(board_shape=args.board_shape,
                               ...
                               model_path_for_local=args.opp_path)
    print()
