"""
    Este módulo contiene todo lo necesario para poder cargar el modelo rfondato.zip.

    Instrucciones:
    - Solo es necesario importar la clase RFondatoPlayer y utilizarla como jugador en los partidos.
